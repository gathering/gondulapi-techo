...
curl -sSf $ENDPOINT_USER --data '{"id": "396345b4-553a-4254-97dc-778bea02a86a", "user_name": "hon", "email_address": "hon@example.net", "first_name": "Håvard", "last_name": "Nordstrand"}'
curl -sSf $ENDPOINT_USER --data '{"user_name": "hon2", "email_address": "hon@example.com", "first_name": "Håvard2", "last_name": "Nordstrand2"}'
...
curl -sSf $ENDPOINT_TRACK --data '{"id": "net1", "type": "net", "station_permanent": true}'
curl -sSf $ENDPOINT_TRACK --data '{"id": "server1", "type": "server", "station_permanent": false, "station_create_url": "https://example.net/create", "station_destroy_url": "https://example.net/destroy", "station_count_max": 10}'

# Tasks
echo
echo "Seeding tasks ..."
ENDPOINT_TRACK="${ENDPOINT}task/"
curl -sSf $ENDPOINT_TRACK --data '{"track": "net1", "shortname": "task1", "name": "Do the first thing", "description": "Desc desc desc", "sequence": 1}'

# Stations
echo
echo "Seeding stations ..."
ENDPOINT_STATION="${ENDPOINT}station/"
curl -sSf $ENDPOINT_STATION --data '{"id": "1932481b-4126-4cf3-8913-49d0faff75f4", "track": "net1", "shortname": "station1", "name": "Station #1", "status": "active", "credentials": "ssh 10.10.10.10 -p 1000\npassword abclol", "notes": "Idk, broken or smtn.\n\nAAAA"}'

# Timeslots
echo
echo "Seeding timeslots ..."
ENDPOINT_TIMESLOT="${ENDPOINT}timeslot/"
curl -sSf $ENDPOINT_TIMESLOT --data '{"user": "396345b4-553a-4254-97dc-778bea02a86a", "track": "server1"}'
curl -sSf $ENDPOINT_TIMESLOT --data '{"user": "396345b4-553a-4254-97dc-778bea02a86a", "track": "net1", "station_shortname": "station1", "begin_time": "2021-03-27T12:12:18.927291Z", "end_time": "2021-03-27T13:12:18.927291Z"}'
